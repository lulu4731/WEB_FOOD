...
<body>
	...
	<section class="order1" id="order">
		...
		<h3 class="sub-heading">Quên mật khẩu</h3>

		<form:form action="update-password.htm" modelAttribute="password"
			...
			<div class="inputBox">
				<div class="input">
					...
					<form:input path="password" placeholder="Nhập mật khẩu!" type="password"></form:input>
				</div>
			</div>
			<div class="inputBox">
				<div class="input">
					<span style="text-align: center">Xác nhận mật khẩu</span> <br> <br>
					<form:errors path="rePassword" element="div" />
					<form:input path="rePassword" placeholder="Nhập mật khẩu lại!" type="password"></form:input>
				</div>
			</div>
