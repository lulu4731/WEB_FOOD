			...
			<form:form action="forgot-password.htm" modelAttribute="user" method="post"
				...
				<div class="inputBox">
					<div class="input">
						...
						<form:input path="email" placeholder="Nhập địa chỉ email!"></form:input>
					</div>
				</div>
			...
			<form:form action="confirm.htm" modelAttribute="user" method="post"
				...
				<div class="inputBox">
					<div class="input">
						...
						<form:input path="code" placeholder="Nhập mã xác nhận!"></form:input>
					</div>
				</div>
				<div class="errors">${message }</div>

				<input type="submit" value="Xác minh mã" class="btn">
