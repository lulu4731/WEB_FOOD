...
<body>
	...
	<section class="order1" id="order">
		...
		<h3 class="sub-heading">Đăng ký</h3>
		<h1 class="heading">Tạo tài khoản để có thể mua hàng</h1>
		...
		<form:form action="signup.htm" modelAttribute="user" method="post"
			...
			<div class="inputBox">
				<div class="input">
					<span style="text-align: center">Họ và tên</span> <br> <br>
					<form:errors path="name" element="div" />
					<form:input path="name" placeholder="Nhập họ và tên của bạn!"></form:input>
				</div>
				<div class="input">
					<span style="text-align: center">Địa chỉ giao hàng</span> <br>
					<br>
					<form:errors path="address" element="div" />
					<form:input path="address" placeholder="Nhập địa chỉ của bạn!"></form:input>
				</div>
				<div class="input">
					<span style="text-align: center">Số thẻ</span> <br> <br>
					<form:errors path="card" element="div" />
					<form:input path="card" type="number"
						placeholder="Nhập số thẻ của bạn!"></form:input>
				</div>
				<div class="input">
					<span style="text-align: center">Số điện thoại</span> <br> <br>
					<form:errors path="phone" element="div" />
					<form:input path="phone" type="number"
						placeholder="Nhập số điện thoại của bạn!"></form:input>
				</div>
				<div class="input">
					<span style="text-align: center">Địa chỉ email</span> <br> <br>
					<form:errors path="email" element="div" />
					<form:input path="email" placeholder="Nhập email của bạn!"></form:input>
				</div>
				<div class="input">
					<span style="text-align: center">Mật khẩu</span> <br> <br>
					<form:errors path="password" element="div" />
					<form:input path="password" type="password"
						placeholder="Nhập mật khẩu của bạn!"></form:input>
				</div>
			</div>
